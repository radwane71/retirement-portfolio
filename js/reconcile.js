...
window.CARD_INFO = {
  'reconcile': {
    ...
    body: `
      ...
      <p class="info-note">⚠️ لا تُعدَّل إلا التواريخ التي تختارها أنت — لا تُمسّ الأسهم أو الأسعار. التواريخ الصحيحة مهمة لأن حسابات XIRR وآخر 12 شهراً تعتمد عليها. (أداة لمن يستورد بياناته من ملفات خارجية.)</p>`
  },
};
