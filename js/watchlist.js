...
// ⚠️ كانت 18–25 وتخالف م.29 (12–18، وحتى 22 مؤقتاً أثناء تنفيذ خروج).
// فمحفظة من 16 سهماً — وهي **داخل** هدف الدستور — كانت تُوسَم ⚠️ «أقلّ
// من اللازم». المصدر الآن ثوابت الدستور لا أرقام مكتوبة هنا.
const WL_SIZE_MIN = (typeof SIZE_MIN === 'number') ? SIZE_MIN : 12;
const WL_SIZE_MAX = (typeof SIZE_MAX === 'number') ? SIZE_MAX : 18;
