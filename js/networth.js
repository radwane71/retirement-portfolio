...
window.CARD_INFO = {
  ...
  'nw-history': {
    ...
    body: `
      ...
      <p class="info-note">💡 احفظ لقطة شهرياً على الأقل ليصبح للرسم معنى — نقطة واحدة لا تروي قصة.</p>`
  },
  'snapshots': {
    title: '📸 اللقطات التاريخية',
    body: `
      <p>«اللقطة» تسجيل لصافي ثروتك في لحظة معيّنة. لا تتحدّث تلقائياً — أنت من يحفظها بزر «حفظ لقطة الآن».</p>
      <div class="info-formula">عمود «التغيير» = صافي هذه اللقطة − صافي اللقطة السابقة</div>
      <p class="info-note">💡 استخدم «تنظيف (لقطة/شهر)» لإبقاء لقطة واحدة لكل شهر ومنع ازدحام الجدول.</p>`
  },
};
