  ...
  overlay.innerHTML = `
    <div class="modal-card">
      ...
      <div class="stack-4">
        ...
        <!-- الأدلّة: مطويّة — قائمة التحقق هي ما فُتحت النافذة لأجله -->
        ${foldHtml('الأدلّة العلمية (Zaimovic 2021 — 150 دراسة)', `• لا يوجد «عدد مثالي» واحد — يعتمد على السوق والمستثمر وقياس المخاطر ودرجة تحمّلك.<br>
          ...
          المعايير العملية: N_فعّال ≥ ١٥ · أكبر مركز ≤ ١٥٪ · أكبر ٣ ≤ ٤٥٪ · ٤+ قطاعات متوازنة.`, { icon: '📚' })}
      </div>
    </div>`;
