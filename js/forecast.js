  ...
  if (note) {
    ...
    note.innerHTML = `
      <div style="border:1px solid rgba(240,180,41,.35);background:rgba(240,180,41,.06);border-radius:10px;padding:12px 15px;line-height:1.75">
        ...
        <div class="small text-muted" style="margin-top:5px">
          هذه نسبة <strong>نمو أبطأ</strong>، لا تبخُّر رأس مال. تاريخياً، احتمال <strong>خسارة فعلية</strong> على مدى 10–20 سنة بعد احتساب التوزيعات النقدية ≈ <strong>6% فقط</strong>، وحتى في أسوأ فترة بتاريخ تاسي كان العائد ≈ <strong>−0.4%/سنة (شبه تعادل)</strong> لا انهيار.
        </div>
