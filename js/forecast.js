    ...
    diagEl.innerHTML = `
      <div class="note"${st ? ` data-state="${st}"` : ''}>
        ...
        <div>
          ...
          <br><br>
          <b>⚠️ لا تقرأ هذا كحكم على أدائك مقابل السوق.</b> المقارنة هنا بين
          <b>نموّك السعري السنوي فقط</b> (أي XIRR بعد استبعاد توزيعاتك) وبين
          <b>متوسط تاسي طويل المدى</b> (~15 سنة). للحكم الفعلي على أدائك انظر
          <a href="performance.html">الأداء التاريخي ← مقارنة بالمؤشر</a> — فهي تقارن
          <b>عائدك الإجمالي شاملاً التوزيعات</b> بتاسي <b>الفعلي في فترتك أنت</b>.
          الصفحتان قد تعطيان نتيجتين متعاكستين وكلاهما صحيح: أن يكون نموّك السعري
          دون المعيار بينما عائدك الكلي يتفوّق عليه يعني ببساطة أن
          <b>تفوّقك مصدره التوزيعات لا ارتفاع الأسعار</b> — وهو أمر مقصود في محفظة دخل.
