...
// ══════════════════════════════════════════════════════════════════════
{
  ...
  t('يُعلن الرمز خارج TWR', /BBB/.test(h) && /خارج TWR/.test(h));
  // ⚠️ الحاشية كانت تقول «تدخل XIRR لأنه لا يحتاج أسعاراً» — وهو **عكس**
  // الواقع: كان يدخل ثمنُها ولا تدخل قيمتُها، فيقرأها خسارةً كاملة.
  t('لا ادّعاء أن XIRR لا يحتاج أسعاراً', !/لا يحتاج أسعاراً/.test(h),
    'الادّعاء عاد — وهو خطأ في المنهج لا في الصياغة');
